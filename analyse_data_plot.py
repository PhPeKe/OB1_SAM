...
def plot_saccerror_type(df_alldata):
    ...
    _range = int(max(df_alldata['saccade_type_by_error'].unique()))
    plt.xticks(range(_range+1),['No error','refixated','forward','after wordskip'], size='large', alpha=0.5, ha='center')
